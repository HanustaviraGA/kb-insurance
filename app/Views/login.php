...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>KB Insurance - Admin Login</title>
		<meta name="description" content="The most advanced Bootstrap Admin Theme on Themeforest trusted by 94,000 beginners and professionals. Multi-demo, Dark Mode, RTL support and complete React, Angular, Vue &amp; Laravel versions. Grab your copy now and get life-time updates for free." />
		<meta name="keywords" content="KB, insurance" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta charset="utf-8" />
		<meta property="og:locale" content="id_ID" />
		<meta property="og:type" content="login" />
		<meta property="og:title" content="KB Insurance - Admin Login" />
		<meta property="og:url" content="<?= base_url(); ?>" />
		<meta property="og:site_name" content="KB Insurance - Admin Login" />
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
							...
							<a href="../../demo1/dist/index.html" class="py-9 mb-5">
								<img alt="Logo" src="<?= base_url('assets/media/logos/kb-insurance.webp') ?>" class="h-90px" />
							</a>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2qx pb-5 pb-md-10">Selamat datang di</h1>
                            <h1 class="fw-bolder fs-2qx pb-5 pb-md-10">KB Insurance</h1>
							<!--end::Title-->
							<!--begin::Description-->
							<p class="fw-bold fs-2" style="color: #986923;">Memfasilitasi premi kendaraan
							<br />kesayangan nasabah Anda</p>
							<!--end::Description-->
						</div>
						<!--end::Content-->
						<!--begin::Illustration-->
						<div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px" style="background-image: url(<?= base_url('assets/media/logos/vehicle.png') ?>)"></div>
						<!--end::Illustration-->
					</div>
					<!--end::Wrapper-->
				</div>
