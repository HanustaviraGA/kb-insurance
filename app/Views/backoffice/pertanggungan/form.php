        ...
        <div class="card card-bordered">
                    ...
                    <div class=" mt-8 mx-3 md:mx-7">
                        ...
                        <div class=" d-md-flex">
                            <div class="fv-row mb-5 col-md-12 px-3 ">
                                ...
                                <input type="text" name="nama_nasabah" id="nama_nasabah" class="form-control bg-white border border-2 py-4 px-6 rounded-3 fw-light fs-6" placeholder="Input Nama Nasabah" required/>
                            </div>
                        </div>
                        ...
                        <div class=" d-md-flex">
                            <div class="fv-row mb-5 col-md-12 px-3 ">
                                ...
                                <input type="text" name="periode_pertanggungan" value="<?= $date ?>" id="periode_pertanggungan" class="form-control bg-white border border-2 py-4 px-6 rounded-3 fw-light fs-6" placeholder="Input Periode Pertanggungan" required/>
                            </div>
                        </div>
                        ...
                        <div class=" d-md-flex">
                            <div class="fv-row mb-5 col-md-12 px-3 ">
                                ...
                                <input type="text" name="pertanggungan_kendaraan" id="pertanggungan_kendaraan" class="form-control bg-white border border-2 py-4 px-6 rounded-3 fw-light fs-6" placeholder="Input Pertanggungan / Kendaraan" required/>
                            </div>
                        </div>
                        ...
                        <div class=" d-md-flex">
                            <div class="fv-row mb-5 col-md-12 px-3 ">
                                ...
                                <input type="number" name="harga_pertanggungan" id="harga_pertanggungan" class="form-control bg-white border border-2 py-4 px-6 rounded-3 fw-light fs-6" placeholder="Input Harga Pertanggungan" required/>
                            </div>
                        </div>
                        ...
                        <div class=" d-md-flex">
                            <div class="fv-row mb-5 col-md-12 px-3 ">
                                ...
                                <select name="jenis_pertanggungan" id="jenis_pertanggungan" class="form-control bg-white border border-2 py-4 px-6 rounded-3 fw-light fs-6" required>
                        ...
                        <div class=" d-md-flex">
                            <div class=" ms-3">
                                ...
                                <div class="fv-row form-check form-switch py-4">
                                    <input class="form-check-input" name="banjir" type="checkbox" checked id="banjir_switch" />
                        ...
                        <div class=" d-md-flex">
                            <div class=" ms-3">
                                <div class="fv-row form-check form-switch py-4">
                                    <input class="form-check-input" name="gempa" type="checkbox" id="gempa_switch" />
                                    <label class="form-check-label" for="flexSwitchDefault">
                                        Gempa
                                    </label>
                                </div>
            ...
            <div class="card-footer d-flex justify-content-lg-end justify-content-center py-6 px-9">
                <div class="d-flex">
                    ...
                    <button id="reset_button" type="reset" onclick="onReset()" class="btn fw-bold fs-5 btn-outline btn-outline-primary btn-sm ms-2 py-3 px-10 px-sm-20 actCreate">
                        Reset
                    </button>
                    <button id="submit_button" type="submit" class="btn fw-bold fs-5 btn-primary btn-sm ms-2 py-3 px-10 px-sm-20 actCreate">
                        Simpan
                    </button>
